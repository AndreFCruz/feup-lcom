 ...
 *
 * @param data parameter that is written in the input buffer
 *
 * @return Return 0 upon success and non-zero otherwise
 */
 ...
 *
 * @param  command command of the action we want to execute and the argument that will be used in that action
